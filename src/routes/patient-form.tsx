...
function PatientFormPage() {
  ...
  const [gender, setGender] = createSignal<'男性' | '女性' | 'その他' | null>(null);
  ...
  return (
    <div class="p-8 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} class="space-y-6 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="flex gap-2">
              <input type="text" placeholder="姓" class="border p-2 rounded-lg w-full" onInput={(e) => setLastName(e.currentTarget.value)} />
              <input type="text" placeholder="名" class="border p-2 rounded-lg w-full" onInput={(e) => setFirstName(e.currentTarget.value)} />
            </div>
          </div>
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="flex gap-2">
              <input type="text" placeholder="セイ" class="border p-2 rounded-lg w-full" 
                value={lastNameKana()} onInput={(e) => setLastNameKana(e.currentTarget.value)} />
              <input type="text" placeholder="メイ" class="border p-2 rounded-lg w-full" 
                value={firstNameKana()} onInput={(e) => setFirstNameKana(e.currentTarget.value)} />
            </div>
          </div>
        ...
        <div class="pt-4 border-t">
          <button type="submit" disabled={mutation.isPending} class="w-full bg-blue-600 text-white py-3 rounded-xl font-bold hover:bg-blue-700 disabled:bg-gray-400">
